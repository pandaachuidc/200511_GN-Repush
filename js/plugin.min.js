/*! Wed May 02 2018 17:57:38  | loreal | loreal design by wunderman | wunderman */
!(function (e) {
  "use strict";
  ...
  (s = 0),
    ((r = function (e, i) {
      ...
      (o.defaults = {
        ...
        (o.windowTimer = null),
        (t = a(e).data("slick") || {}),
        (o.options = a.extend({}, o.defaults, i, t)),
      ...
      if (!0 === t.options.dots && t.slideCount > t.options.slidesToShow) {
        for (
          t.$slider.addClass("slick-dotted"),
            i = a("<ul />").addClass(t.options.dotsClass),
            e = 0;
          e <= t.getDotCount();
          e += 1
        )
    ...
    (r.prototype.cleanUpEvents = function () {
      ...
      e.options.dots &&
        ...
        (a("li", e.$dots)
          ...
          .off("mouseenter.slick", a.proxy(e.interrupt, e, !0))
          .off("mouseleave.slick", a.proxy(e.interrupt, e, !1)),
        ...
        !0 === e.options.focusOnSelect &&
          a(e.$slideTrack).children().off("click.slick", e.selectHandler),
        a(window).off(
          "orientationchange.slick.slick-" + e.instanceUid,
          e.orientationChange
        ),
        a(window).off("resize.slick.slick-" + e.instanceUid, e.resize),
        a("[draggable!=true]", e.$slideTrack).off(
          "dragstart",
          e.preventDefault
        ),
      ...
      return (
        ...
        !0 === s.options.swipeToSlide
          ? (s.$slideTrack.find(".slick-slide").each(function (e, i) {
              if (i.offsetLeft - o + a(i).outerWidth() / 2 > -1 * s.swipeLeft)
                return (t = i), !1;
            }),
    ...
    (r.prototype.init = function (e) {
      ...
      a(i.$slider).hasClass("slick-initialized") ||
        (a(i.$slider).addClass("slick-initialized"),
        i.buildRows(),
        i.buildOut(),
        i.setProps(),
        i.startLoad(),
    ...
    (r.prototype.initDotEvents = function () {
      ...
      !0 === e.options.dots &&
        ...
        !0 === e.options.dots &&
          ...
          e.slideCount > e.options.slidesToShow &&
          a("li", e.$dots)
            .on("mouseenter.slick", a.proxy(e.interrupt, e, !0))
            .on("mouseleave.slick", a.proxy(e.interrupt, e, !1));
    }),
    (r.prototype.initSlideEvents = function () {
      var e = this;
      e.options.pauseOnHover &&
        (e.$list.on("mouseenter.slick", a.proxy(e.interrupt, e, !0)),
    ...
    (r.prototype.initializeEvents = function () {
      ...
      e.initArrowEvents(),
        ...
        !0 === e.options.focusOnSelect &&
          a(e.$slideTrack).children().on("click.slick", e.selectHandler),
        a(window).on(
          "orientationchange.slick.slick-" + e.instanceUid,
          a.proxy(e.orientationChange, e)
        ),
        a(window).on(
    ...
    (r.prototype.lazyLoad = function () {
      ...
      if (
        ...
        for (
          var s = i - 1, r = t, l = n.$slider.find(".slick-slide"), d = 0;
    ...
    (r.prototype.refresh = function (e) {
      ...
      (t = o.slideCount - o.options.slidesToShow),
        ...
        (i = o.currentSlide),
        o.destroy(!0),
        a.extend(o, o.initials, { currentSlide: i }),
        o.init(),
    ...
    (r.prototype.selectHandler = function (e) {
      var i = a(e.target).is(".slick-slide")
          ? a(e.target)
          : a(e.target).parents(".slick-slide"),
          ...
          !l.options.verticalSwiping && !l.swiping && 4 < r
            ...
            : (!0 === l.options.verticalSwiping &&
              ...
              !1 === l.options.vertical
                ? (l.swipeLeft = i + o * s)
                : (l.swipeLeft = i + o * (l.$list.height() / l.listWidth) * s),
  ...
  (function (e, i) {
    ...
    var i,
      ...
      g = function (e) {
        for (
          var i = e.offsetWidth, t = e.offsetHeight, o = 0, s = 0;
          isNaN(e.offsetTop) || (o += e.offsetTop),
            isNaN(e.offsetLeft) || (s += e.offsetLeft),
            null !== (e = e.offsetParent);

        );
        return { width: i, height: t, top: o, left: s };
      },
      c = function (e) {
        ...
        var i,
          ...
          r =
            ((i = u) !== window
              ? ((t = i.clientWidth), (o = i.clientHeight))
              : ((t =
          ...
          l =
            (s = u) !== window
              ? { x: s.scrollLeft + g(s).left, y: s.scrollTop + g(s).top }
              : {
    ...
    return (
      (l.init = function (e) {
        ...
        (u = (e = e || {}).container || window),
          (n = void 0 === e.reset || e.reset),
          (r = void 0 === e.handheld || e.handheld),
          (s = o(e.throttle, 250)),
          (i = e.elemCushion),
          (t = 0.15),
          (h = parseFloat(i || t)),
            ...
            ? ((a() && r) || !a()) &&
              ...
              window.addEventListener
                ? (window.addEventListener("load", p, !1),
                  ...
                  u.addEventListener("resize", p, !1))
                : (document.attachEvent("onreadystatechange", function () {
                    "complete" === document.readyState && p();
                  }),
                  u.attachEvent("onscroll", p),
      ...
      (l.engage = function () {
        for (
          var e,
            i = document.querySelectorAll("[data-emergence]"),
            t = i.length,
            o = 0;
          o < t;
          o++
          ...
          (e = i[o]),
            c(e)
              ? (e.setAttribute("data-emergence", "visible"),
                (e.className = e.className),
                d(e, "visible"))
              : !0 === n
              ? (e.setAttribute("data-emergence", "hidden"),
                (e.className = e.className),
                d(e, "reset"))
              : !1 === n && d(e, "noreset");
        t || l.disengage();
      ...
      (l.disengage = function () {
        window.removeEventListener
          ? (u.removeEventListener("scroll", p, !1),
            u.removeEventListener("resize", p, !1))
          : (u.detachEvent("onscroll", p), u.detachEvent("onresize", p)),
          clearTimeout(i);
      }),
      l
    );
